...
export const experiences: Experience[] = [
    {
        ...
        description: "Working on the global IT Asset Management project at headquarters, leading group-wide software installation analysis alongside contract oversight and compliance management.",
        tags: ["Group ITAM", "SAM Analysis", "IT Project Management", "Contracts & Compliance"],
        current: true,
        highlight: false,
    },
    {
